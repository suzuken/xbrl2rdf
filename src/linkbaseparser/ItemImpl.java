...
public class ItemImpl implements Item {
	...
	public ItemImpl(String name, String id, String type,
	...
	public String toString() {
		return "ItemImpl [name=" + name + ", id=" + id + ", type=" + type
				+ ", substitutionGroup=" + substitutionGroup
				+ ", abstractBoolean=" + abstractBoolean + ", nillable="
				+ nillable + ", periodType=" + periodType + "]";
	}
